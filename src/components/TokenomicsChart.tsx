...
const TokenomicsChart: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 p-8 rounded-lg items-center justify-center">
      <h1 className="text-4xl lg:text-6xl font-semibold text-center lg:text-left w-full">
        Tokenomics
      </h1>
