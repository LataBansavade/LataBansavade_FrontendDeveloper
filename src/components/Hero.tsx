...
export default function Hero() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden text-white">
      ...
      <nav className="fixed top-0 left-0 py-6 px-5 flex justify-between w-full items-center">
        {/* Logo */}
        ...
        <div
          ...
          } md:block bg-[#071d20b2] p-4 fixed left-0 top-0 w-full h-full md:relative md:w-auto md:h-auto bg-opacity-5 rounded-3xl backdrop-blur-md border border-[#294143b2] shadow-md`}
        >
          ...
          <ul className="flex flex-col md:flex-row gap-6 md:gap-8 text-md px-6 py-4 md:py-0 relative">
